      ...
      <section className="py-20 gradient-bg">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-primary">Powerful Automations</span>
          </h1>
          <p className="text-xl max-w-3xl mx-auto mb-10 text-muted">
            Build complex workflow automations for n8n, Zapier, and Make using
            simple English descriptions. No coding required.
          </p>
