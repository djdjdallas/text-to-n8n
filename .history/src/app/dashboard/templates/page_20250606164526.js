...
import { Search, Filter, Download, Eye, Tag, Clock, User, ChevronDown } from 'lucide-react';
...
const TemplatesPage = () => {
  ...
  const sampleTemplates = [
    {
      ...
      description: 'Automate your social media content creation for auto service businesses. Uses AI to generate posts, create images, and publish to multiple platforms.',
      category: 'Marketing',
    ...
    },
    {
      ...
      description: 'Build a voice-enabled AI agent that can chat about your documents using ElevenLabs for voice and InfraNodus Knowledge Graphs.',
      category: 'AI Agents',
    ...
    },
    {
      ...
      description: 'Automatically clone viral TikTok videos, generate similar content with AI, and distribute to 9 social media platforms.',
    ...
    },
    {
      ...
      description: 'Process PDF documents using Mistral OCR, store in Qdrant vector database, and enable RAG for intelligent document querying.',
    ...
    },
    {
      ...
      description: 'Automate business lead scraping using Apify and export cleaned data directly to Google Sheets for easy management.',
    ...
    },
    {
      ...
      description: 'AI assistant for email and calendar management with Gmail integration, automatic email classification, and scheduling.',
  ...
  const categories = ['all', 'Marketing', 'AI Agents', 'Content Creation', 'Document Processing', 'Lead Generation', 'Productivity'];
  ...
  const handleUseTemplate = (templateId) => {
    // In production, this would fetch the full JSON and open it in n8n
    console.log('Using template:', templateId);
    // You could redirect to n8n with the template data or trigger a download
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Ready-to-use n8n workflows to jumpstart your automation</p>
        </div>
                ...
                <div className="absolute top-full mt-2 w-full bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                  {categories.map(cat => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 hover:bg-gray-50 ${selectedCategory === cat ? 'bg-blue-50 text-blue-600' : ''}`}
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTemplates.map(template => (
            <div key={template.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
              {/* Featured Badge */}
