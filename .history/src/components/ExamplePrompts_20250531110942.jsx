...
const examples = [
  {
    ...
    prompt: 'When a new email arrives in Gmail, extract attachments and save them to Google Drive',
  ...
  },
  {
    ...
    prompt: 'Every Monday at 9 AM, fetch data from our CRM and create a weekly report in Slack',
  ...
  },
  {
    ...
    prompt: 'Monitor our website for downtime and send alerts to the team via Discord',
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {examples.map((example) => (
          <Card key={example.id} className="hover:border-primary/50 transition-all">
            <CardHeader>
