...
CRITICAL: Your output MUST be a valid ${platform} workflow JSON containing ONLY these fields:
- name, nodes, connections, settings, meta (REQUIRED)
- versionId, pinData, staticData, tags (OPTIONAL)NEVER include:
- _metadata or any underscore-prefixed fields
- instructions, validation, or any explanatory fields
- Any fields not explicitly listed above

The workflow will FAIL to import if you include any forbidden fields.`;
  }
...
- Use loops/iterators where appropriate`;
  ...
  - Any field starting with underscore (FORBIDDEN)
  - Any field not in the allowed list above (FORBIDDEN)
  ...
  FINAL CHECK: Before responding, verify your JSON contains ONLY the allowed fields listed above.`;
  }
  /**
